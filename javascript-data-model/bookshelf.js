...
console.log("value of second book's author:", bookshelf[1].author);
console.log("value of first book's ISBN:", bookshelf[0].isbn);
console.log("value of third book's title:", bookshelf[2].title);
